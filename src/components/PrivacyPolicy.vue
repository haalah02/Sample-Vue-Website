...
<h1 class="privacy-policy-h1">Privacy Policy
    <br><span>Last Updated On 30-Aug-2023</span>
    <br><span>Effective Date 30-Aug-2023</span>
    </h1>
    ...
    <p class="privacy-policy-p">
        ...
        when you use our website ( https://sample-vue-website.vercel.app ).
    ...
    <ol class="privacy-policy-ol">
        ...
        <li>
            ...
            <p class="privacy-policy-p">
                ...
                <a href="https://sample-vue-website.vercel.app/policy">Cookie Policy.</a>
            </p>
        </li>
